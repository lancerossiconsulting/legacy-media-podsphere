...
The expansion of pool access to podcasters, newsletter writers, and YouTube journalists is a recognition — grudging on both sides — that the audience-attention function of journalism has migrated to a degree that legacy credentialing can no longer monopolize the room. The independent podsphere figures now in the briefing room are there because ignoring them means ignoring an audience that is larger, in many cases, than the audience that legacy organizations command.
