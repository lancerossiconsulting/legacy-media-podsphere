...
title: "Downloads"
kicker: "Files"
meta: "Word, PDF, PowerPoint, and Markdown copies · June 18, 2026"
permalink: /downloads/
description: "Downloadable copies of the Legacy Media and the Podsphere package — .docx, .pdf, .pptx, and Markdown."
dropcap: false
---

Each piece in the package is available for download. Word and PDF copies are generated from the same working drafts published on this site. Files are updated with each substantive revision; check the version date in each piece's metadata line for currency.

<ul class="download-list">
  <li><a href="{{ '/downloads/legacy-media-podsphere-journal-article.docx' | relative_url }}">Journal Article — "The Reluctant Migrant"</a><span class="format">Word</span></li>
  ...
  <li><a href="{{ '/downloads/legacy-media-podsphere-podcast-outline.md' | relative_url }}">Podcast Outline</a><span class="format">Markdown</span></li>
  <li><a href="{{ '/downloads/legacy-media-podsphere-qr.png' | relative_url }}">Site QR Code</a><span class="format">PNG, print resolution</span></li>
</ul>
